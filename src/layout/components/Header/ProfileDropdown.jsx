  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 transition"
      >
        {/* Profile Picture or Initial - Render only ONE */}
        {user?.profilePic ? (
          <img 
            src={user.profilePic} 
            alt={user?.name}
            ...
            onError={(e) => {
              ...
              fallback.className = 'w-9 h-9 rounded-full bg-purple-600 flex items-center justify-center text-white font-semibold';
          ...
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
            ...
            <div className="px-4 py-3 border-b border-gray-200">
              <div className="flex items-center mb-2">
                {/* Profile Picture in Dropdown - Render only ONE */}
                {user?.profilePic ? (
                  <img 
                    src={user.profilePic} 
                    alt={user?.name}
